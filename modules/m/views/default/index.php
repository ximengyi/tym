...
<div id="slideBox" class="slideBox">
    <div class="bd">
     ...
     <?php   foreach ($image_list as $image_info):?>
                        <li><img style="max-height: 250px;" src="<?=UrlService::buildPicUrl("brand",$image_info["image_key"]);?>" /></li>
          <?php endforeach; ?>
        </ul>
    </div>
...
<div class="fastway_list_box">
    <ul class="fastway_list">
        ...
        <li><a href="<?=UrlService::buildNullUrl();?>;" style="padding-left: 0.1rem;"><span>品牌介绍：<?=UtilService::encode( $info['address'] );?></span></a></li>
    </ul>
</div>
